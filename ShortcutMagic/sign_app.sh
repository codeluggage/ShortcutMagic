...
codesign --verbose --force --sign "$identity" "$app/Contents/Frameworks/Electron Framework.framework/Versions/A"
codesign --verbose --force --sign "$identity" "$app/Contents/Frameworks/Electron Helper EH.app"
codesign --verbose --force --sign "$identity" "$app/Contents/Frameworks/Electron Helper NP.app"
codesign --verbose --force --sign "$identity" "$app/Contents/Frameworks/Electron Helper.app"
codesign --verbose --force --sign "$identity" "$app/Contents/Frameworks/Mantle.framework/Versions/A"
codesign --verbose --force --sign "$identity" "$app/Contents/Frameworks/ReactiveCocoa.framework/Versions/A"
codesign --verbose --force --sign "$identity" "$app/Contents/Frameworks/Squirrel.framework/Versions/A"
codesign --verbose --force --sign "$identity" "$app"
